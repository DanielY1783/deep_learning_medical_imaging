...
NEW_TRAIN_LABELS_FILTERED = "../../../data/Train/no_register/label_cropped_filtered_nr/"
OLD_TRAIN_LABELS = "../../../data/Train/label/"
NEW_TRAIN_LABELS = "../../../data/Train/no_register/label_cropped_nr/"
OLD_TRAIN_IMG = "../../../data/Train/img/"
NEW_TRAIN_IMG = "../../../data/Train/no_register/img_cropped_nr/"
NEW_VAL_LABELS_FILTERED = "../../../data/Val/no_register/label_cropped_filtered_nr/"
OLD_VAL_LABELS = "..././../data/Val/label/"
NEW_VAL_LABELS = "../../../data/Val/no_register/label_cropped_nr/"
OLD_VAL_IMG = "../../../data/Val/img/"
NEW_VAL_IMG = "../../../data/Val/no_register/img_cropped_nr/"
...
print("Percentage of Training Labels that is spleen: ", new_train_sum / (224*224*85*24))
...
print("Percentage of Val Labels that is spleen: ", new_val_sum / (224*224*85*6))
