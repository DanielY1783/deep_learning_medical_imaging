...
MODEL_NAME_X = "network_multilabel_x.pt"
MODEL_NAME_Y = "network_multilabel_y.pt"
...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.fc2_x = nn.Linear(256, 20)
        self.fc2_y = nn.Linear(256, 20)
...
def test(args, model, device, test_loader, test_losses):
    ...
    print('\nTest set: Average loss: {:.6f}\n'.format(
        test_error))
    print("Correct Validation instances: ", correct)
...
def main():
    ...
    train_data = DetectionImages(csv_file="../data/labels/multiclass_train_labels.txt", root_dir="../data/train", transform=ToTensor())
    train_loader = DataLoader(train_data, batch_size=args.batch_size, shuffle=True, num_workers=0)
    test_data_x = DetectionImages(csv_file="../data/labels/multiclass_validation_labels.txt", root_dir="../data/validation", transform=ToTensor())
    ...
    for i in range(50):
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if lowest_loss > test_losses[epoch - 1]:
                ...
                print(output_y)
                # Save the model
                torch.save(model.state_dict(), MODEL_NAME_X)
        ...
        if best_model:
            ...
            plt.legend()
            # Save the figure
            plt.savefig('curve_multilabel.png')
            plt.close()
